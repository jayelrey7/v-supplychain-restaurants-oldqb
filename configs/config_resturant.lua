...
Businesses.Businesses = {
        ...
        storage = {
            {
                ...
                inventory = {
                    ...
                    weight = 4000000 -- Maximum weight in KG
                },
                ...
                items = {
                    {
                        ...
                        progressLabel = "Preparing aluminium",
                        requiredItems = {
                            { item = "aluminum", amount = 10 },
                            { item = "aluminumoxide", amount = 10 }
                        },
                    ...
                    },
                    {
                        ...
                        amount = 50,
                        time = 8000, -- Time to prepare the item in milliseconds
                        progressLabel = "Preparing Forged Steel",
                        requiredItems = {
                            { item = "iron", amount = 10 },
                    ...
                    },
                    {
                        ...
                        amount = 50,
                        time = 8000, -- Time to prepare the item in milliseconds
                        progressLabel = "Preparing Titanium",
                        requiredItems = {
                    ...
                    },
                    {
                        ...
                        amount = 50,
                        time = 8000, -- Time to prepare the item in milliseconds
                        progressLabel = "Preparing Super Metal",
                        requiredItems = {
                            { item = "aluminum", amount = 10 },
                            { item = "titanium", amount = 10 }
                        },
                        icon = "fa-solid fa-flask"
                    },
                    {
                        ...
                        amount = 50,
                        time = 8000, -- Time to prepare the item in milliseconds
                        progressLabel = "Preparing Unobtanium",
                        requiredItems = {
                            { item = "super", amount = 10 },
                            { item = "aluminumoxide", amount = 10 }
                        },
                        icon = "fa-solid fa-flask"
                    },
                    {
                        ...
                        amount = 50,
                        time = 8000, -- Time to prepare the item in milliseconds
                        progressLabel = "Preparing Indestructible Metal",
                        requiredItems = {
                            { item = "aluminum", amount = 10 },
                            { item = "aluminumoxide", amount = 10 },
                            { item = "ironoxide", amount = 10 }
                        },
                        icon = "fa-solid fa-flask"
                    },
    ...
    tuning = {
        ...
        clockin = {
            coords = vector4(2744.28, 3474.53, 60.28, 60.8),
            dimensions = { width = 1.5, length = 0.6, height = 0.6 } -- Dimensions for clockin area
        },
        ...
        storage = {
            {
                coords = vector4(2658.34, 3495.35, 55.72, 158.33),
                targetLabel = "Open Stop Car Storage",
                inventory = {
                    slots = 50, -- Number of inventory slots
                    weight = 4000000 -- Maximum weight in KG
                },
